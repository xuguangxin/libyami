...
class IVideoPostProcess {
  public:
    ...
    virtual YamiStatus setParameters(VppParamType type, const void* params) = 0;
    virtual YamiStatus getParameters(VppParamType type, void* params) = 0;
